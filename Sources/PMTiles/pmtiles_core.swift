...
#if canImport(pmtiles_coreFFI)
import pmtiles_coreFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_pmtiles_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_pmtiles_core_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsurePmtilesCoreInitialized()
...
open class PmTilesReader: PmTilesReaderProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_pmtiles_core_fn_clone_pmtilesreader(self.handle, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_pmtiles_core_fn_free_pmtilesreader(handle, $0) }
    }
...
public struct FfiConverterTypePmTilesReader: FfiConverter {
    ...
    public static func lift(_ handle: UInt64) throws -> PmTilesReader {
        return PmTilesReader(unsafeFromHandle: handle)
    }

    public static func lower(_ value: PmTilesReader) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PmTilesReader {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: PmTilesReader, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePmTilesReader_lift(_ handle: UInt64) throws -> PmTilesReader {
    return try FfiConverterTypePmTilesReader.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePmTilesReader_lower(_ value: PmTilesReader) -> UInt64 {
...
#if compiler(>=6)
extension PmTilesError: Sendable {}
#endif
...
public struct FfiConverterTypePmTilesError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: PmTilesError, into buf: inout [UInt8]) {
        switch value {
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_pmtiles_core_uniffi_contract_version()
...
public func uniffiEnsurePmtilesCoreInitialized() {
