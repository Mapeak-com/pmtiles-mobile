...
open class PmTilesReader: PmTilesReaderProtocol, @unchecked Sendable {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_pmtiles_core_fn_clone_pmtilesreader(self.pointer, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_pmtiles_core_fn_free_pmtilesreader(pointer, $0) }
    }
...
public struct FfiConverterTypePmTilesReader: FfiConverter {
    ...
    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> PmTilesReader {
        return PmTilesReader(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: PmTilesReader) -> UnsafeMutableRawPointer {
...
extension PmTilesError: Equatable, Hashable {}




extension PmTilesError: Foundation.LocalizedError {
    public var errorDescription: String? {
