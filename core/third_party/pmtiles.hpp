// ============================================================================
// Vendored from protomaps/PMTiles  ->  cpp/pmtiles.hpp
//   Source:  https://github.com/protomaps/PMTiles/blob/main/cpp/pmtiles.hpp
//   Commit:  e90f14cc86fb88cf083f4082d207d1a89eaba320
//   License: BSD-3-Clause (reference implementations in protomaps/PMTiles).
//            The PMTiles specification itself is public domain / CC0.
//
// This is upstream code, vendored verbatim. To update, re-download from the
// path above and bump the commit SHA here so changes stay deliberate. Do not
// hand-edit; the reader logic lives in ../src/reader.cpp against these symbols.
// ============================================================================
#ifndef PMTILES_HPP
#define PMTILES_HPP
